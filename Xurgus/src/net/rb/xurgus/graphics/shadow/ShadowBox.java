package net.rb.xurgus.graphics.shadow;
...
public class ShadowBox {
    ...
    public Vector4f[] calculateFrustumVertices(Matrix4f rotation, Vector3f forwardVector,
    ...
    public Vector4f calculateLightSpaceFrustumCorner(Vector3f startPoint, Vector3f direction,
            float width) {
    ...
    public void calculateWidthsAndHeights() {
        ...
        nearWidth = (float) (RenderManager.NEAR_PLANE
                * Math.tan(Math.toRadians(RenderManager.FOV)));
